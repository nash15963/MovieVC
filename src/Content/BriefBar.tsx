...
const BriefBar = () => {
    ...
    let nowPlayDataUrl:string = 'https://api.themoviedb.org/3/movie/now_playing?api_key=7dcd0053886fc8ec5f0fc4ee25fa55a1&language=zh-TW&page=1' ;
    let popularUrl:string = 'https://api.themoviedb.org/3/movie/popular?api_key=7dcd0053886fc8ec5f0fc4ee25fa55a1&language=zh-TW&page=1';
    let topRatedUrl:string = 'https://api.themoviedb.org/3/movie/top_rated?api_key=7dcd0053886fc8ec5f0fc4ee25fa55a1&language=zh-TW&page=1' ;
    let upcomingUrl:string = 'https://api.themoviedb.org/3/movie/upcoming?api_key=7dcd0053886fc8ec5f0fc4ee25fa55a1&language=zh-TW&page=1' ;
    ...
    const handleFetchData =(url:string ,useHook:React.Dispatch<React.SetStateAction<movieBrief[]>>
        )=>{
        fetch(url)
        .then((res)=>res.json())
        .then((myJson)=>{
            // console.log(myJson);
            useHook(myJson.results.map((ele:any)=>{
                return{
                    id :ele.id ,
    ...
    const handleEachMovie =(id?:number):void=>{
        navigate(`/watchs/${id}`);
    }
