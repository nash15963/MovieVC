...
const Watch = () => {
  ...
  const FetchMovieDetail =async()=>{
    if(movieId){
      let detailUrl:string = `https://api.themoviedb.org/3/movie/${movieId}?api_key=7dcd0053886fc8ec5f0fc4ee25fa55a1&language=zh-TW`
  ...
  const FetchMovieVideo = async()=>{
    if(movieId){
      let EnVideoUrl:string = `https://api.themoviedb.org/3/movie/${movieId}/videos?api_key=7dcd0053886fc8ec5f0fc4ee25fa55a1&language=en-US` 
  ...
  return (
    <div className='video-parent'>
      ...
      <div className='video-frame'>
        {videoLoad ? <div className='loading'></div>
        :noVideo ? <h5>很抱歉，目前沒有關於這部電影的影片</h5>
        ...
        {showMore ? <p className='skip-line' onClick={HandleHideDetail}>完整資訊...</p> :<p className='skip-line' onClick={HandleHideDetail}>更少資訊</p>}
        ...
        {movieId ? <RelativeMovieComponents movieId={movieId} setVideoData={setVideoData}/> : ''}
