...
const Login = ({ setUsername ,setPassword ,setFlip ,username ,password ,setmMmberMessage ,memberMessage ,useAccessRight}:LoginInterface) => {
  ...
  return (
    ...
    <p>還沒有會員帳號嗎？ <span onClick={()=>{setFlip(true)}}>註冊會員</span></p>
